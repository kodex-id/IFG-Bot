...
let handler = async (m, { conn, usedPrefix, text }) => {
 ...
 // else conn.reply(m.chat, 'Minimal 10 Aqua untuk kamu menambang, karena menambang membutuhkan energi, seperti mendapat dia >,,<', m)
  m.reply(`Selamat kamu mendapatkan : \nBerlian sebanyak ${berlians}\nEmas sebanyak ${emasbiasas}\nDiamond sebanyak ${emasbatangs} \n\ndan 1  Tiketcoin`)
  setTimeout(() => {
					conn.reply(m.chat, `kamu sudah boleh menambang lagi`, m)
					}, timeout)
}
