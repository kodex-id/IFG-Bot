...
let handler = async (m, { isPrems }) => {
  ...
  if (new Date - global.db.data.users[m.sender].lastmonthly < 2592000000) throw `Kamu sudah mengambil hadiah bulanan untuk bulan ini.\nTunggu ${msToTime(time - new Date())} lagi`
