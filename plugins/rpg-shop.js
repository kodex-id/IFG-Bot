            ...
            case 'buy':
                switch (_type) {
                    case 'potion':
                            if (global.db.data.users[m.sender].money >= potion * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Potion dengan harga ${potion * count} coin\n\nGunakan potion dengan ketik: *${usedPrefix}use potion <jumlah>*`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} Potion dengan harga ${potion * count} coin`,)
                        break
                    case 'diamond':
                            if (global.db.data.users[m.sender].money >= Bdiamond * count) {
                                global.db.data.users[m.sender].diamond += count * 1
                                global.db.data.users[m.sender].money -= Bdiamond * count
                                conn.reply(m.chat, `Succes membeli ${count} Diamond dengan harga ${Bdiamond * count} coin`, m)
                            } else conn.reply(m.chat, `coin anda tidak cukup`, m)
                    ...
                    case 'common':
                            if (global.db.data.users[m.sender].money >= Bcommon * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Common crate dengan harga ${Bcommon * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} Common crate dengan harga ${Bcommon * count} coin\n\nBuka crate dengan ketik: *${usedPrefix}open common*`, m)
                    ...
                    case 'uncommon':
                            if (global.db.data.users[m.sender].money >= Buncommon * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Uncommon crate dengan harga ${Buncommon * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} Uncommon crate dengan harga ${Buncommon * count} coin\n\nBuka crate dengan ketik: *${usedPrefix}open uncommon*`, m)
                    ...
                    case 'mythic':
                            if (global.db.data.users[m.sender].money >= Bmythic * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Mythic crate dengan harga ${Bmythic * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} Mythic crate dengan harga ${Bmythic* count} coin\n\nBuka crate dengan ketik: *${usedPrefix}open mythic*`, m)
                    ...
                    case 'legendary':
                            if (global.db.data.users[m.sender].money >= Blegendary * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Legendary crate dengan harga ${Blegendary * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} Legendary crate dengan harga ${Blegendary * count} coin\n\nBuka crate dengan ketik: *${usedPrefix}open legendary*`, m)
                    ...
                    case 'sampah':
                            if (global.db.data.users[m.sender].money >= Bsampah * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Sampah dengan harga ${Bsampah * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} Sampah dengan harga ${Bsampah * count} coin`.trim(), m)
                    ...
                    case 'kaleng':
                            if (global.db.data.users[m.sender].money >= Bkaleng * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Kaleng dengan harga ${Bkaleng * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} Kaleng dengan harga ${Bkaleng * count} coin`.trim(), m)
                    ...
                    case 'kardus':
                            if (global.db.data.users[m.sender].money >= Bkardus * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Kardus dengan harga ${Bkardus * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} Kardus dengan harga ${Bkardus * count} coin`.trim(), m)
                    ...
                    case 'botol':
                            if (global.db.data.users[m.sender].money >= Bbotol * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Botol dengan harga ${Bbotol * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} botol dengan harga ${Bbotol * count} coin`.trim(), m)
                    ...
                    case 'kayu':
                            if (global.db.data.users[m.sender].money >= Bkayu * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Kayu dengan harga ${Bkayu * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} kayu dengan harga ${Bkayu * count} coin`.trim(), m)
                    ...
                    case 'pisang':
                            if (global.db.data.users[m.sender].money >= Bpisang * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Pisang dengan harga ${Bpisang * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} pisang dengan harga ${Bpisang * count} coin`.trim(), m)
                    ...
                    case 'anggur':
                            if (global.db.data.users[m.sender].money >= Banggur * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Anggur dengan harga ${Banggur * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} anggur dengan harga ${Banggur * count} coin`.trim(), m)
                    ...
                    case 'mangga':
                            if (global.db.data.users[m.sender].money >= Bmangga * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Mangga dengan harga ${Bmangga * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} mangga dengan harga ${Bmangga * count} coin`.trim(), m)
                    ...
                    case 'jeruk':
                            if (global.db.data.users[m.sender].money >= Bjeruk * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Jeruk dengan harga ${Bjeruk * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} jeruk dengan harga ${Bjeruk * count} coin`.trim(), m)
                    ...
                    case 'apel':
                            if (global.db.data.users[m.sender].money >= Bapel * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Apel dengan harga ${Bapel * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} apel dengan harga ${Bapel * count} coin`.trim(), m)
                    ...
                    case 'bibitpisang':
                            if (global.db.data.users[m.sender].money >= Bbibitpisang * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Bibit Pisang dengan harga ${Bbibitpisang * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} bibit pisang dengan harga ${Bbibitpisang * count} coin`.trim(), m)
                    ...
                    case 'bibitanggur':
                            if (global.db.data.users[m.sender].money >= Bbibitanggur * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Bibit Anggur dengan harga ${Bbibitanggur * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} bibit anggur dengan harga ${Bbibitanggur * count} coin`.trim(), m)
                    ...
                    case 'bibitmangga':
                            if (global.db.data.users[m.sender].money >= Bbibitmangga * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Bibit Mangga dengan harga ${Bbibitmangga * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} bibit mangga dengan harga ${Bbibitmangga * count} coin`.trim(), m)
                    ...
                    case 'bibitjeruk':
                            if (global.db.data.users[m.sender].money >= Bbibitjeruk * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Bibit Jeruk dengan harga ${Bbibitjeruk * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} bibit jeruk dengan harga ${Bbibitjeruk * count} coin`.trim(), m)
                    ...
                    case 'bibitapel':
                            if (global.db.data.users[m.sender].money >= Bbibitapel * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Bibit Apel dengan harga ${Bbibitapel * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} bibit apel dengan harga ${Bbibitapel * count} coin`.trim(), m)
                    ...
                    case 'gardenboxs':
                            if (global.db.data.users[m.sender].money >= Bgardenboxs * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Gardenboxs dengan harga ${Bgardenboxs * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} gardenboxs dengan harga ${Bgardenboxs * count} coin`.trim(), m)
                    ...
                    case 'berlian':
                            if (global.db.data.users[m.sender].money >= Bberlian * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Berlian dengan harga ${Bberlian * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} berlian dengan harga ${Bberlian * count} coin`.trim(), m)
                    ...
                    case 'emas':
                            if (global.db.data.users[m.sender].money >= Bemasbiasa * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Emas dengan harga ${Bemasbiasa * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} emas dengan harga ${Bemasbiasa * count} coin`.trim(), m)
                     ...
                     case 'pet':
                            if (global.db.data.users[m.sender].money >= Bpet * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Pet Random dengan harga ${Bpet * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} pet random dengan harga ${Bpet * count} coin`.trim(), m)
                   ...
                   case 'limit':
                            ...
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} limit dengan harga ${Blimit * count} coin`.trim(), m)
                   ...
                   /*case 'exp':
                            ...
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} exp dengan harga ${Bexp * count} coin`.trim(), m)
                     ...
                     case 'eleksirb':
                            if (global.db.data.users[m.sender].money >= Beleksirb * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Eleksir Biru dengan harga ${Beleksirb * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} Eleksir Biru dengan harga ${Beleksirb * count} coin`.trim(), m)
                        ...
                        case 'koinexpg':
                            if (global.db.data.users[m.sender].money >= Bkoinexpg * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Koinexpg dengan harga ${Bkoinexpg * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} koinexpg dengan harga ${Bkoinexpg * count} coin`.trim(), m)
                  ...
                  case 'makananpet':
                            if (global.db.data.users[m.sender].money >= Bmakananpet * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Makanan Pet dengan harga ${Bmakananpet * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} makanan pet dengan harga ${Bmakananpet * count} coin`.trim(), m)
                ...
                case 'makanannaga':
                            if (global.db.data.users[m.sender].money >= Bmakanannaga * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Makanan Naga dengan harga ${Bmakanannaga * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} makanan naga dengan harga ${Bmakanannaga * count} coin`.trim(), m)
                 ...
                 case 'makananphonix':
                            if (global.db.data.users[m.sender].money >= Bmakananphonix * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Makanan Phonix dengan harga ${Bmakananphonix * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} makanan phonix dengan harga ${Bmakananphonix * count} coin`.trim(), m)
                ...
                case 'makanankyubi':
                            if (global.db.data.users[m.sender].money >= Bmakanankyubi * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Makanan Kyubi dengan harga ${Bmakanankyubi * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} makanan kyubi dengan harga ${Bmakanankyubi * count} coin`.trim(), m)
                 ...
                 case 'makanangriffin':
                            if (global.db.data.users[m.sender].money >= Bmakanangriffin * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Makanan Griffin dengan harga ${Bmakanangriffin * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} makanan griffin dengan harga ${Bmakanangriffin * count} coin`.trim(), m)
                  ...
                  case 'makanancentaur':
                            if (global.db.data.users[m.sender].money >= Bmakanancentaur * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Makanan Centaur dengan harga ${Bmakanancentaur * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} makanan centaur dengan harga ${Bmakanancentaur * count} coin`.trim(), m)
                  ...
                  case 'tiketm':
                            if (global.db.data.users[m.sender].money >= Bhealtmonster * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} TiketM dengan harga ${Bhealtmonster * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} tiketm dengan harga ${Bhealtmonster * count} coin`.trim(), m)
                  ...
                  case 'aqua':
                            if (global.db.data.users[m.sender].money >= Baqua * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Aqua dengan harga ${Baqua * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} aqua dengan harga ${Baqua * count} coin`.trim(), m)
                  ...
                  case 'iron':
                            if (global.db.data.users[m.sender].money >= Biron * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Iron dengan harga ${Biron * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} iron dengan harga ${Biron * count} coin`.trim(), m)
                  ...
                  case 'string':
                            if (global.db.data.users[m.sender].money >= Bstring * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} String dengan harga ${Bstring * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} string dengan harga ${Bstring * count} coin`.trim(), m)
                  ...
                  case 'sword':
                            if (global.db.data.users[m.sender].money >= Bsword * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Sword dengan harga ${Bsword * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} sword dengan harga ${Bsword * count} coin`.trim(), m)
                  ...
                  case 'batu':
                            if (global.db.data.users[m.sender].money >= Bbatu * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Batu dengan harga ${Bbatu * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} batu dengan harga ${Bbatu * count} coin`.trim(), m)
                    ...
                    case 'umpan':
                            if (global.db.data.users[m.sender].money >= Bumpan * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Umpan dengan harga ${Bumpan * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} umpan dengan harga ${Bumpan * count} coin`.trim(), m)
                    ...
                    case 'pancingan':
                            if (global.db.data.users[m.sender].money >= Bpancingan * count) {
                                ...
                                conn.reply(m.chat, `Succes membeli ${count} Pancingan dengan harga ${Bpancingan * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} pancingan dengan harga ${Bpancingan * count} coin`.trim(), m)
                    ...
                    case 'armor':
                            ...
                            if (global.db.data.users[m.sender].money > armor) {
                                ...
                                conn.reply(m.chat, `Succes membeli armor seharga ${armor} coin` ,m)
                            } else conn.reply(m.chat, `Coin mu tidak cukup untuk membeli armor seharga ${armor} coin`, m)
                ...
                switch (_type) {
                    case 'potion':
                        if (global.db.data.users[m.sender].potion >= count * 1) {
                            ...
                            global.db.data.users[m.sender].potion -= count * 1
                            conn.reply(m.chat, `Succes menjual ${count} Potion dengan harga ${Spotion * count} coin`.trim(), m)
                    ...
                    case 'common':
                        if (global.db.data.users[m.sender].common >= count * 1) {
                            ...
                            global.db.data.users[m.sender].common -= count * 1
                            conn.reply(m.chat, `Succes menjual ${count} Common Crate dengan harga ${Scommon * count} coin`.trim(), m)
                    ...
                    case 'uncommon':
                        if (global.db.data.users[m.sender].uncommon >= count * 1) {
                            ...
                            global.db.data.users[m.sender].uncommon -= count * 1
                            conn.reply(m.chat, `Succes menjual ${count} Uncommon Crate dengan harga ${Suncommon * count} coin`.trim(), m)
                    ...
                    case 'mythic':
                        if (global.db.data.users[m.sender].mythic >= count * 1) {
                            ...
                            global.db.data.users[m.sender].mythic -= count * 1
                            conn.reply(m.chat, `Succes menjual ${count} Mythic Crate dengan harga ${Smythic * count} coin`.trim(), m)
                    ...
                    case 'legendary':
                        if (global.db.data.users[m.sender].legendary >= count * 1) {
                            ...
                            global.db.data.users[m.sender].legendary -= count * 1
                            conn.reply(m.chat, `Succes menjual ${count} Legendary Crate dengan harga ${Slegendary * count} coin`.trim(), m)
                    ...
                    case 'sampah':
                        if (global.db.data.users[m.sender].sampah >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} sampah, dan anda mendapatkan ${Ssampah * count} coin`, m)
                    ...
                    case 'kaleng':
                        if (global.db.data.users[m.sender].kaleng >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} kaleng, dan anda mendapatkan ${Skaleng * count} coin`, m)
                    ...
                    case 'kardus':
                        if (global.db.data.users[m.sender].kardus >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} kardus, dan anda mendapatkan ${Skardus * count} coin`, m)
                    ...
                    case 'botol':
                        if (global.db.data.users[m.sender].botol >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} botol, dan anda mendapatkan ${Sbotol * count} coin`, m)
                    ...
                    case 'kayu':
                        if (global.db.data.users[m.sender].kayu >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} kayu, dan anda mendapatkan ${Skayu * count} coin`, m)
                    ...
                    case 'pisang':
                        if (global.db.data.users[m.sender].pisang >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} pisang, dan anda mendapatkan ${Spisang * count} coin`, m)
                    ...
                    case 'anggur':
                        if (global.db.data.users[m.sender].anggur >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} anggur, dan anda mendapatkan ${Sanggur * count} coin`, m)
                    ...
                    case 'mangga':
                        if (global.db.data.users[m.sender].mangga >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} mangga, dan anda mendapatkan ${Smangga * count} coin`, m)
                    ...
                    case 'jeruk':
                        if (global.db.data.users[m.sender].jeruk >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} jeruk, dan anda mendapatkan ${Sjeruk * count} coin`, m)
                   ...
                   case 'berlian':
                        if (global.db.data.users[m.sender].berlian >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} berlian, dan anda mendapatkan ${Sberlian * count} coin`, m)
                   ...
                   case 'emas':
                        if (global.db.data.users[m.sender].emas >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} emas , dan anda mendapatkan ${Semasbiasa * count} coin`, m)
                    ...
                    case 'pet':
                        if (global.db.data.users[m.sender].pet >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} pet random, dan anda mendapatkan ${Spet * count} coin`, m)
                    ...
                    case 'makananpet':
                        if (global.db.data.users[m.sender].makananpet >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} makanan pet, dan anda mendapatkan ${Smakananpet * count} coin`, m)
                    ...
                    case 'makananphonix':
                        if (global.db.data.users[m.sender].makananphonix >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} makanan phonix, dan anda mendapatkan ${Smakananphonix * count} coin`, m)
                    ...
                    case 'makanannaga':
                        if (global.db.data.users[m.sender].makanannaga >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} makanan naga, dan anda mendapatkan ${Smakanannaga * count} coin`, m)
                    ...
                    case 'makanankyubi':
                        if (global.db.data.users[m.sender].makanankyuni >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} makanan kyubi, dan anda mendapatkan ${Smakanankyubi* count} coin`, m)
                    ...
                    case 'makanangriffin':
                        if (global.db.data.users[m.sender].makanangriffin >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} makanan griffin, dan anda mendapatkan ${Smakanangriffin * count} coin`, m)
                    ...
                    case 'makanancentaur':
                        if (global.db.data.users[m.sender].makanancentaur >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} makanan centaur, dan anda mendapatkan ${Smakanancentaur * count} coin`, m)
                    ...
                    case 'aqua':
                        if (global.db.data.users[m.sender].aqua >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} aqua, dan anda mendapatkan ${Saqua * count} coin`, m)
                    ...
                    case 'pancingan':
                        if (global.db.data.users[m.sender].pancingan >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} pancingan, dan anda mendapatkan ${Spancingan * count} coin`, m)
                    ...
                    case 'iron':
                        if (global.db.data.users[m.sender].iron >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} pancingan, dan anda mendapatkan ${Siron * count} coin`, m)
                    ...
                    case 'string':
                        if (global.db.data.users[m.sender].string >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} string, dan anda mendapatkan ${Sstring * count} coin`, m)
                    ...
                    case 'sword':
                        if (global.db.data.users[m.sender].sword >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} sword, dan anda mendapatkan ${Ssword * count} coin`, m)
                    ...
                    case 'batu':
                        if (global.db.data.users[m.sender].batu >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} batu, dan anda mendapatkan ${Sbatu * count} coin`, m)
                    ...
                    case 'limit':
                        if (global.db.data.users[m.sender].limit >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} limit, dan anda mendapatkan ${Slimit * count} coin`, m)
                    ...
                    case 'diamond':
                        if (global.db.data.users[m.sender].diamond >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} Diamond, dan anda mendapatkan ${Sdiamond * count} coin`, m)
            ...
            switch (type) {
                case 'potion':
                        if (global.db.data.users[m.sender].money >= potion * count) {
                            ...
                            global.db.data.users[m.sender].potion += count * 1
                            conn.reply(m.chat, `Succes membeli ${count} Potion dengan harga ${potion * count} coin\n\nGunakan potion dengan ketik: *${usedPrefix}use potion <jumlah>*`, m)
                        } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} Potion dengan harga ${potion * count} coin`,m)
                ...
                case 'sampah':
                    ...
                    case 'berlian':
                            if (global.db.data.users[m.sender].money >= Bberlian * count) {
                                global.db.data.users[m.sender].berlian += count * 1
                                global.db.data.users[m.sender].money -= Bberlian * count
                                conn.reply(m.chat, `Succes membeli ${count} Apel dengan harga ${Bberlian * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} berlian dengan harga ${Bberlian * count} coin`.trim(), m)
                ...
                case 'makanannaga':
                            if (global.db.data.users[m.sender].money >= Bmakanannaga * count) {
                                ...
                                global.db.data.users[m.sender].money -= Bmakanannaga * count
                                conn.reply(m.chat, `Succes membeli ${count} Makanan Naga dengan harga ${Bmakanannaga * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} makanan pet dengan harga ${Bmakanannaga * count} coin`.trim(), m)
                 ...
                 case 'makananphonix':
                            if (global.db.data.users[m.sender].money >= Bmakananphonix * count) {
                                ...
                                global.db.data.users[m.sender].money -= Bmakananphonix * count
                                conn.reply(m.chat, `Succes membeli ${count} Makanan Phonix dengan harga ${Bmakananphonix * count} coin`, m)
                            } else conn.reply(m.chat, `Coin anda tidak cukup untuk membeli ${count} makanan pet dengan harga ${Bmakananphonix * count} coin`.trim(), m)
            ...
            switch (type) {
                ...
                case 'sampah':
                    if (global.db.data.users[m.sender].sampah >= count * 1) {
                        global.db.data.users[m.sender].sampah -= count * 1
                        global.db.data.users[m.sender].money += Ssampah * count
                        conn.reply(m.chat, `Succes menjual ${count} sampah, dan anda mendapatkan ${Ssampah * count} coin`.trim(), m)
