...
let handler = async (m, { isPrems }) => {
  ...
  if (new Date - global.db.data.users[m.sender].lastweekly < 604800000) throw `Kamu sudah mendapatkan hadiah mingguan ini\ntunggu ${msToTime(time - new Date())} lagi`
    //    conn.reply(m.chat, `Kamu sudah mengklaim dan mendapatkan :`, m)
