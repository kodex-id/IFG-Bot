...
conn.level = global.db.data.users[m.sender]
  ...
  if (typeof conn.fight[m.sender] != "undefined" && conn.fight[m.sender] == true) return m.reply(`*Tidak bisa melakukan pertarungan lagi karena kamu sedang dalam pertarungan.*`)
